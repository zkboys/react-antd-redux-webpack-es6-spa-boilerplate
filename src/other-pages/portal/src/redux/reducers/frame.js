...
import {getNodeByPropertyAndValue, getTopNodeByNode} from 'zk-react/utils/tree-utils';
...
export default handleActions({
    [types.SET_SYSTEM_MENUS_STATUS_BY_URL](state) {
        ...
        if (menuTreeData) {
            ...
            if (currentSideBarMenuNode && !currentSideBarMenuNode.parentKey) { // 说明取到的是一个父节点
